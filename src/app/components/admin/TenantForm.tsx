...
export function TenantForm({ tenant, onBack, onSave }: TenantFormProps) {
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              ...
              <select className="w-full px-4 py-2.5 bg-input-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring transition-all">
